...
export namespace Prisma {
  ...
  */
  ...
  > {
    ...
    ): {} extends InputErrors ? GetEventGroupByPayload<T> : PrismaPromise<InputErrors>
  }
  ...
  type GetEventCategoryGroupByPayload<T extends EventCategoryGroupByArgs> = PrismaPromise<
    Array<
  ...
  > {
     ...
     **/
    findUnique<
      T extends EventCategoryFindUniqueArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined
    >(
     ...
     **/
    findFirst<
      T extends EventCategoryFindFirstArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined
    >(
    ...
    ): PrismaPromise<GetEventCategoryAggregateType<T>>
    ...
    ): {} extends InputErrors ? GetEventCategoryGroupByPayload<T> : PrismaPromise<InputErrors>
  }
  ...
  export type EventCategoryCreateNestedManyWithoutUserInput = {
    create?: XOR<
      Enumerable<EventCategoryCreateWithoutUserInput>,
      Enumerable<EventCategoryUncheckedCreateWithoutUserInput>
    >
  ...
  export type EventCreateNestedManyWithoutCategoryInput = {
    create?: XOR<
      Enumerable<EventCreateWithoutCategoryInput>,
      Enumerable<EventUncheckedCreateWithoutCategoryInput>
    >
  ...
  export type EventCategoryUpdateManyWithWhereWithoutUserInput = {
    ...
    data: XOR<
      ...
      EventCategoryUncheckedUpdateManyWithoutCategoriesInput
    >
  }
